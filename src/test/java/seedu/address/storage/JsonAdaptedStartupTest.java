...
public class JsonAdaptedStartupTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedStartup startup =
                new JsonAdaptedStartup(INVALID_NAME, VALID_INDUSTRY, VALID_FUNDING,
                    VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_VALUATION, VALID_NOTES, VALID_TAGS);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedStartup startup =
                new JsonAdaptedStartup(VALID_NAME, VALID_INDUSTRY, VALID_FUNDING,
                    INVALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_VALUATION, VALID_NOTES, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedStartup startup = new JsonAdaptedStartup(VALID_NAME, VALID_INDUSTRY, VALID_FUNDING,
            null, VALID_EMAIL, VALID_ADDRESS, VALID_VALUATION, VALID_NOTES, VALID_TAGS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedStartup startup =
                new JsonAdaptedStartup(VALID_NAME, VALID_INDUSTRY, VALID_FUNDING,
                    VALID_PHONE, INVALID_EMAIL, VALID_ADDRESS, VALID_VALUATION, VALID_NOTES, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedStartup startup = new JsonAdaptedStartup(VALID_NAME, VALID_INDUSTRY, VALID_FUNDING,
            VALID_PHONE, null, VALID_ADDRESS, VALID_VALUATION, VALID_NOTES, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedStartup startup =
                new JsonAdaptedStartup(VALID_NAME, VALID_INDUSTRY, VALID_FUNDING,
                    VALID_PHONE, VALID_EMAIL, INVALID_ADDRESS, VALID_VALUATION, VALID_NOTES, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedStartup startup = new JsonAdaptedStartup(VALID_NAME, VALID_INDUSTRY, VALID_FUNDING,
            VALID_PHONE, VALID_EMAIL, null, VALID_VALUATION, VALID_NOTES, VALID_TAGS);
    ...
    public void toModelType_invalidValuation_throwsIllegalValueException() {
        JsonAdaptedStartup startup =
          new JsonAdaptedStartup(VALID_NAME, VALID_INDUSTRY, VALID_FUNDING,
            VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, INVALID_VALUATION, VALID_NOTES, VALID_TAGS);
    ...
    public void toModelType_nullValuation_throwsIllegalValueException() {
        JsonAdaptedStartup startup = new JsonAdaptedStartup(VALID_NAME, VALID_INDUSTRY, VALID_FUNDING,
          VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, null, VALID_NOTES, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedStartup startup =
                new JsonAdaptedStartup(VALID_NAME, VALID_INDUSTRY, VALID_FUNDING,
                    VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_VALUATION, VALID_NOTES, invalidTags);
