...
public class StartupUtil {
    ...
    public static String getStartupDetails(Startup startup) {
        ...
        sb.append(PREFIX_VALUATION + startup.getValuation().value + " ");
    ...
    public static String getEditStartupDescriptorDetails(EditStartupDescriptor descriptor) {
        ...
        descriptor.getValuation().ifPresent(valuation ->
                sb.append(PREFIX_VALUATION).append(valuation.value).append(" "));
