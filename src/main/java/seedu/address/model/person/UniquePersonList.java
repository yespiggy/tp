 ...
 * A startup is considered unique by comparing using {@code Startup#isSamePerson(Person)}. As such, adding and
...
public class UniquePersonList implements Iterable<Person> {
    ...
    public boolean equals(Object other) {
        ...
        seedu.address.model.person.UniquePersonList otherUniquePersonList = (seedu.address.model.person.UniquePersonList) other;
